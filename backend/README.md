...
## 🤖 使用的模型資訊：Gemini 2.5 Flash Lite

本專案升級為使用 **Gemini 2.5 Flash Lite** (`gemini-2.0-flash-lite-preview-02-05`)，這是目前 Google 性價比最高的輕量級模型。
...
> 相較於標準版 Flash ($0.15/$0.60)，Lite 版本節省約 33% 成本，且效能足以應付文件問答。

### 相關連結

- [Gemini 模型列表與定價](https://ai.google.dev/gemini-api/docs/models/gemini#gemini-2.0-flash-lite)
- [Gemini 2.5 Flash Lite 官方文件](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/models/gemini/2-5-flash-lite?hl=zh-tw#2.5-flash-lite)
