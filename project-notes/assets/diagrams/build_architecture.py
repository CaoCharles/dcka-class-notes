...
def system_page() -> Page:
    ...
    p.nodes = [
        ...
        Node("cloud-build", 1110, 175, 200, 105, "Cloud Build", ["SA: dcka-cloud-build", "roles/run.builder"], COLORS["green_fill"], COLORS["green"]),
...
def delivery_page() -> Page:
    ...
    p.nodes = [
        ...
        Node("b-build", 940, 705, 220, 135, "Cloud Build", ["--source backend", "SA: dcka-cloud-build", "roles/run.builder"], COLORS["green_fill"], COLORS["green"]),
